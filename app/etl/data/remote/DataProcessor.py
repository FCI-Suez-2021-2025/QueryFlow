...
class DataProcessor :
    ...
    def calculate_wind_direction(self,u_component_of_wind_10m, v_component_of_wind_10m):
        # https://confluence.ecmwf.int/pages/viewpage.action?pageId=133262398
    ...
    def calculate_relative_humidity(self,temperature, dewpoint_temp):
        ...
        actual_vapor_pressure = 6.11 * (10 ** ((17.625 * dewpoint_temp) / (243.04 + dewpoint_temp)))
        saturation_vapor_pressure = 6.11 * (10 ** ((17.625 * temperature) / (243.04 + temperature)))
