...
_lr_action_items = {'SELECT':([0,],[6,]),'INSERT':([0,],[7,]),'UPDATE':([0,],[8,]),'DELETE':([0,],[9,]),'$end':([1,2,3,4,5,24,33,35,43,46,48,49,50,51,52,60,76,79,83,84,85,86,87,99,],[0,-1,-2,-3,-4,-5,-9,-17,-16,-24,-25,-26,-27,-28,-29,-8,-23,-7,-19,-20,-18,-21,-22,-6,]),'DISTINCT':([6,],[11,]),'TIMES':([6,10,11,12,],[-5,17,-30,-31,]),'COLNUMBER':([6,10,11,12,23,26,28,41,97,],[-5,20,-30,-31,20,20,20,20,20,]),'COLNAME':([6,10,11,12,23,26,28,34,41,44,47,65,66,69,70,71,72,73,74,75,97,],[-5,21,-30,-31,21,21,21,48,21,48,48,48,48,48,-10,-11,-12,-13,-14,-15,21,]),'INTO':([7,36,],[13,54,]),'DATASOURCE':([8,13,15,25,54,],[14,22,24,36,78,]),'FROM':([9,16,17,18,19,20,21,37,],[15,25,-36,-37,-35,-32,-33,-34,]),'SET':([14,],[23,]),'COMMA':([18,19,20,21,31,37,39,50,51,52,56,57,62,63,64,81,82,91,92,98,],[26,-35,-32,-33,41,26,26,-27,-28,-29,80,-53,-56,-47,-48,93,-50,80,-51,93,]),'RPAREN':([19,20,21,37,39,46,48,49,50,51,52,63,64,67,76,81,82,83,84,85,86,87,98,],[-35,-32,-33,-34,59,-24,-25,-26,-27,-28,-29,-47,-48,85,-23,92,-50,-19,-20,-18,-21,-22,-49,]),'EQUAL':([20,21,32,45,46,48,49,50,51,52,],[-32,-33,42,70,-24,-25,-26,-27,-28,-29,]),'ASC':([20,21,101,],[-32,-33,103,]),'DESC':([20,21,101,],[-32,-33,105,]),'LIMIT':([20,21,35,36,43,46,48,49,50,51,52,53,55,76,77,78,83,84,85,86,87,88,90,101,102,103,104,105,],[-32,-33,-17,-5,-16,-24,-25,-26,-27,-28,-29,-5,-39,-23,-5,-38,-19,-20,-18,-21,-22,95,-41,-5,-40,-42,-43,-44,]),'SIMICOLON':([20,21,30,31,35,36,40,43,46,48,49,50,51,52,53,55,56,57,61,62,63,64,76,77,78,83,84,85,86,87,88,90,91,92,94,96,100,101,102,103,104,105,],[-32,-33,-5,-58,-17,-5,60,-16,-24,-25,-26,-27,-28,-29,-5,-39,79,-53,-57,-56,-47,-48,-23,-5,-38,-19,-20,-18,-21,-22,-5,-41,-52,-51,99,-46,-45,-5,-40,-42,-43,-44,]),'LPAREN':([22,34,38,44,47,65,66,80,],[28,44,58,44,44,44,44,58,]),'VALUES':([22,27,29,59,],[-5,38,-55,-54,]),'WHERE':([24,30,31,36,50,51,52,53,55,61,62,63,64,78,],[34,34,-58,-5,-27,-28,-29,34,-39,-57,-56,-47,-48,-38,]),'NOT':([34,44,47,65,66,],[47,47,47,47,47,]),'STRING':([34,42,44,47,58,65,66,68,69,70,71,72,73,74,75,93,],[46,63,46,46,63,46,46,86,46,-10,-11,-12,-13,-14,-15,63,]),'NEGATIVE_INTNUMBER':([34,42,44,47,58,65,66,69,70,71,72,73,74,75,93,],[50,50,50,50,50,50,50,50,-10,-11,-12,-13,-14,-15,50,]),'POSITIVE_INTNUMBER':([34,42,44,47,58,65,66,69,70,71,72,73,74,75,93,95,],[51,51,51,51,51,51,51,51,-10,-11,-12,-13,-14,-15,51,100,]),'FLOATNUMBER':([34,42,44,47,58,65,66,69,70,71,72,73,74,75,93,],[52,52,52,52,52,52,52,52,-10,-11,-12,-13,-14,-15,52,]),'ORDER':([35,36,43,46,48,49,50,51,52,53,55,76,77,78,83,84,85,86,87,],[-17,-5,-16,-24,-25,-26,-27,-28,-29,-5,-39,-23,89,-38,-19,-20,-18,-21,-22,]),'AND':([43,46,48,49,50,51,52,67,76,83,84,85,86,87,],[65,-24,-25,-26,-27,-28,-29,65,65,65,65,-18,-21,-22,]),'OR':([43,46,48,49,50,51,52,67,76,83,84,85,86,87,],[66,-24,-25,-26,-27,-28,-29,66,66,66,66,-18,-21,-22,]),'LIKE':([45,46,48,49,50,51,52,],[68,-24,-25,-26,-27,-28,-29,]),'NOTEQUAL':([45,46,48,49,50,51,52,],[71,-24,-25,-26,-27,-28,-29,]),'BIGGER_EQUAL':([45,46,48,49,50,51,52,],[72,-24,-25,-26,-27,-28,-29,]),'BIGGER':([45,46,48,49,50,51,52,],[73,-24,-25,-26,-27,-28,-29,]),'SMALLER_EQUAL':([45,46,48,49,50,51,52,],[74,-24,-25,-26,-27,-28,-29,]),'SMALLER':([45,46,48,49,50,51,52,],[75,-24,-25,-26,-27,-28,-29,]),'BY':([89,],[97,]),}
...
_lr_goto_items = {'start':([0,],[1,]),'select':([0,],[2,]),'insert':([0,],[3,]),'update':([0,],[4,]),'delete':([0,],[5,]),'distinct':([6,],[10,]),'empty':([6,22,24,30,36,53,77,88,101,],[12,29,35,35,55,35,90,96,104,]),'select_columns':([10,],[16,]),'columns':([10,26,28,],[18,37,39,]),'column':([10,23,26,28,41,97,],[19,32,19,19,32,101,]),'icolumn':([22,],[27,]),'assigns':([23,41,],[30,61,]),'assign':([23,41,],[31,31,]),'where':([24,30,53,],[33,40,77,]),'conditions':([34,44,47,65,66,],[43,67,76,83,84,]),'exp':([34,44,47,65,66,69,],[45,45,45,45,45,87,]),'NUMBER':([34,42,44,47,58,65,66,69,93,],[49,64,49,49,64,49,49,49,64,]),'into':([36,],[53,]),'insert_values':([38,80,],[56,91,]),'single_values':([38,80,],[57,57,]),'value':([42,58,93,],[62,82,82,]),'logical':([45,],[69,]),'values':([58,93,],[81,98,]),'order':([77,],[88,]),'limit':([88,],[94,]),'way':([101,],[102,]),}
...
_lr_productions = [
  ...
  ('limit -> LIMIT POSITIVE_INTNUMBER','limit',2,'p_limit','yacc.py',261),
  ('limit -> empty','limit',1,'p_limit_empty','yacc.py',269),
  ('value -> STRING','value',1,'p_value','yacc.py',279),
  ('value -> NUMBER','value',1,'p_value','yacc.py',280),
  ('values -> values COMMA values','values',3,'p_values','yacc.py',286),
  ('values -> value','values',1,'p_values_end','yacc.py',298),
  ('single_values -> LPAREN values RPAREN','single_values',3,'p_single_values','yacc.py',303),
  ('insert_values -> insert_values COMMA insert_values','insert_values',3,'p_insert_values','yacc.py',308),
  ('insert_values -> single_values','insert_values',1,'p_insert_values_end','yacc.py',315),
  ('icolumn -> LPAREN columns RPAREN','icolumn',3,'p_icolumn','yacc.py',325),
  ('icolumn -> empty','icolumn',1,'p_icolumn_empty','yacc.py',330),
  ('assign -> column EQUAL value','assign',3,'p_assign','yacc.py',340),
  ('assigns -> assign COMMA assigns','assigns',3,'p_assigns','yacc.py',345),
  ('assigns -> assign','assigns',1,'p_assigns_end','yacc.py',350),
]
