...
_lr_productions = [
  ...
  ('order -> ORDER BY column way','order',4,'p_order_by','yacc.py',224),
  ...
  ('limit -> LIMIT FLOATNUMBER','limit',2,'p_limit','yacc.py',250),
